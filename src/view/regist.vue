    ...
    <div class="regist">
        ...
        <div class="form-box">
            ...
            <div class="regist-form-0" v-if="current == 0">
                ...
                <div class="agreement">
                    <Checkbox v-model="agreedState"></Checkbox>
                    <span>已阅读并接受用户协议</span>
                </div>
            ...
            <div class="regist-form-1" v-if="current == 1">
                <input type="text" v-model="username" class="username" placeholder="请输入用户名，3～30位字母、数字和字符">
...
export default {
    ...
    methods: {
        ...
        info_submit() {
            ...
            if (!/^[0-9a-zA-Z?!_-]{3,30}$/.test(this.username)) {
                err_arr.push("用户名格式错误");
            }
...
<style lang="less">
@import "../assets/styles/regist.less";
</style>
